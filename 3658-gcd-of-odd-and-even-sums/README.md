<h2><a href="https://leetcode.com/problems/gcd-of-odd-and-even-sums/?envType=problem-list-v2&envId=math">3658. GCD of Odd and Even Sums</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code>. Your task is to compute the <strong>GCD</strong> (greatest common divisor) of two values:</p>
